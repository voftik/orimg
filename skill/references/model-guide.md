...
| `openai/gpt-image-2` | ~$0.03–0.13 | Newest OpenAI flagship (dedicated Images API, June 2026): best instruction following, excellent text, FULL aspect-ratio set incl. 16:9/9:16/21:9, n up to 10, 16 refs | Slower at high quality, camera params approximate, no transparent background | Strict multi-object briefs, UI/product mockups, dense infographics, identity-sensitive edits — the default OpenAI slot |
